...
struct OnboardingView: View {
    ...
    private let pages: [(String, String, String)] = [
        ...
        ("leaf.circle.fill", "Grow a real-time garden", "Side gardens grant seed packs. Plant, wait or watch an ad, harvest into Classic tiles. Ultra blooms can wipe the board."),
